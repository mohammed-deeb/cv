...
const Project8 = () => {
  ...
  const images = [
    { url: BasePath + "/projects/project-8/image1.jpg", alt: "project-8 - Image 1" },
    { url: BasePath + "/projects/project-8/image2.jpg", alt: "project-8 - Image 2" },
    { url: BasePath + "/projects/project-8/image3.jpg", alt: "project-8 - Image 3" },
    { url: BasePath + "/projects/project-8/image4.jpg", alt: "project-8 - Image 4" },
    { url: BasePath + "/projects/project-8/image5.jpg", alt: "project-8 - Image 5" },
  ];
